...
<h2 class="wp-block-heading has-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:1.6px;text-transform:uppercase"><?php esc_html_e( 'Other Posts', 'mosayco' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-query">
	...
	<!-- wp:query-no-results -->
		...
		<p class="has-medium-font-size"><?php esc_html_e( 'No posts were found.', 'mosayco' ); ?></p>
		<!-- /wp:paragraph -->
	<!-- /wp:query-no-results -->
</div>
<!-- /wp:query -->
