 ...
 * Slug: mosayco/heading-and-paragraph-with-image
 * Categories: about
...
<!-- wp:group {"metadata":{"categories":["text","about"],"patternName":"mosayco/heading-and-paragraph-with-image"},"align":"full","className":"is-style-section-4","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			...
			<figure class="wp-block-image size-full">
				<img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/image-from-rawpixel-id-8803077-original.webp' ); ?>" alt="<?php echo esc_attr_x( 'A classic black and white photo of an old church', 'Alt text for Overview picture', 'mosayco' ); ?>" style="aspect-ratio:1;object-fit:cover" />
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
